...
public class SystemUtils {
    ...
    public static int getActionBarHeight(Activity paramActivity) {
        if (null != ((AppCompatActivity) paramActivity).getSupportActionBar()) {
            return ((AppCompatActivity) paramActivity).getSupportActionBar().getHeight();
        } else {
            if (Build.VERSION.SDK_INT < 21) {
                return Utils.dip2px(56);
            } else {
                return Utils.dip2px(48);
            }
        }
...
//        return ta.getDimensionPixelSize(0, Utils.dip2px(56));
    ...
    public static int getKeyboardHeight(Activity paramActivity) {
        ...
        if (height == 0) {
            height = ActivityHelper.getIntShareData("KeyboardHeight", Utils.dip2px(280));
        } else {
